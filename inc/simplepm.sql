...
--
-- Хост: localhost
-- Время создания: Фев 25 2018 г., 13:07
...
INSERT INTO `spm_problems` (`id`, `enabled`, `difficulty`, `catId`, `name`, `description`, `input`, `output`, `authorSolution`, `authorSolutionLanguage`, `testsInformation`) VALUES
...
(1017, 1, 3, 6, 'Индекс наибольшего', '&lt;p&gt;Найти индекс последнего наибольшего элемента числовой последовательности.&lt;/p&gt;', 'Во входном потоке в первой строке задано целое число N - количество элементов целочисленной числовой последовательности (0 < N < 100). Во второй строке через пробел перечислены значения элементов числовой последовательности. Значения элементов по модулю не превышают 30000.', 'В выходной поток вывести единственное целое число.', NULL, NULL, NULL),
(1018, 1, 3, 6, 'Индекс наименьшего', '&lt;p&gt;Найти индекс последнего наименьшего элемента числовой последовательности. Нумерация элементов массива с единицы.&lt;/p&gt;', 'Во входном потоке в первой строке задано целое число N - количество элементов целочисленной числовой последовательности (0 < N < 100). Во второй строке через пробел перечислены значения элементов числовой последовательности. Значения элементов по модулю не превышают 30000.', 'В выходной поток вывести единственное целое число.', NULL, NULL, NULL),
