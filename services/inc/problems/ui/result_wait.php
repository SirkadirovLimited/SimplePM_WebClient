...
<div>
	...
	<div align="center" class="party" style="margin-top: -20px; margin-bottom: 30px;">
		...
		<p class="lead">Отправка, компиляция и тестирование вашего решения может занять некоторое время. Обычно этот процесс занимает не более 3 секунд, но всё зависит от обстоятельств. 
