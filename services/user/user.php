...
<div class="row">
	<div class="col-md-4">
		...
		<div>
			...
			<h4 style="z-index: 10; position: absolute; right: 20px; top: 10px;"><?php print($user_is_online); ?></h4>
		</div>
		
		<?php
			if (permission_check($user_info["permissions"], PERMISSION::administrator)){
		?>
		<img src="<?php print(_S_MEDIA_IMG_); ?>dark_side.jpg" class="userAvatar" />
		<?php
			}
		?>
		...
		<?php
			if ($_SESSION['uid'] == $user_info['id']){
		?>
		<h3>Редактирование</h3>
		<ul class="nav nav-pills nav-stacked">
			<li role="presentation"><a href="index.php?service=user.edit&id=<?php print($id); ?>#editProfile">Редактировать информацию</a></li>
			<li role="presentation"><a href="index.php?service=user.edit&id=<?php print($id); ?>#editAvatar">Изменить аватар</a></li>
			<li role="presentation"><a href="index.php?service=user.edit&id=<?php print($id); ?>#editPass">Изменить пароль</a></li>
			<li role="presentation"><a href="index.php?service=user.edit&id=<?php print($id); ?>#settings">Настройки</a></li>
		</ul>
		<?php
			}else{
		?>
